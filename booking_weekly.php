...
<head>
<meta charset="UTF-8">
<title>Weekly Booking Log</title>
...
<!-- PRINT HEADER (PRINT SAHAJA) -->
<div class="print-header">
    <img src="assets/logo.png" alt="KKPPS Logo">
    <div class="title">SISTEM PENGURUSAN KUNCI KKPPS</div>
    <div class="subtitle">
        Laporan Penggunaan Kunci (Weekly)<br>
        Minggu: <?= htmlspecialchars($week) ?>
    </div>
</div>

<h2 class="no-print">📅 Weekly Booking Log</h2>
